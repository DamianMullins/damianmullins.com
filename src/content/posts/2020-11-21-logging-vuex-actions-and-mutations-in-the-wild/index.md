...
![Screenshot of the Chrome devtools elements panel showing the root element of the Vue application highlighted.](devtools-root-element.png)
...
![Screenshot of the Vuex instance object in the Chrome devtools console panel.](devtools-vuex-instance-expanded.png)
...
![Screenshot of a Vuex mutation logged to the Devtools console.](devtools-log-mutation.png)
...
![Screenshot of a Vuex action logged to the Devtools console.](devtools-log-action.png)
...
![Screenshot of a Vuex action and mutation logged to the Devtools console.](devtools-styled-logs.png)
